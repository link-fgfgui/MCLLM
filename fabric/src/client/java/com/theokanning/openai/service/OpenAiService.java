...
public class OpenAiService {
     ...
     */
    public OpenAiService(final String token, final String BASE_URL) {
        this(token, BASE_URL, DEFAULT_TIMEOUT);
    }
     ...
     */
    public OpenAiService(final String token, final String BASE_URL, final Duration timeout) {
        this(buildApi(token, BASE_URL, timeout));
    }
    ...
    public static OpenAiApi buildApi(String token, String BASE_URL, Duration timeout) {
        Objects.requireNonNull(token, "OpenAI token required");
        Objects.requireNonNull(BASE_URL, "BASE_URL required");
    ...
    public static Retrofit defaultRetrofit(OkHttpClient client, ObjectMapper mapper, String BASE_URL) {
